...
our %config = (
  ...
  CFLAGS => [ "-Wall -O3" ],
  CPPDEFINES => [ "TEST_ENG_OPENSSL_NO_ALGORITHMS" ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  build_infos => [ "./build.info", "crypto/build.info", "ssl/build.info", "apps/build.info", "test/build.info", "util/build.info", "tools/build.info", "fuzz/build.info", "crypto/objects/build.info", "crypto/md4/build.info", "crypto/md5/build.info", "crypto/sha/build.info", "crypto/hmac/build.info", "crypto/siphash/build.info", "crypto/sm3/build.info", "crypto/des/build.info", "crypto/aes/build.info", "crypto/rc4/build.info", "crypto/aria/build.info", "crypto/bf/build.info", "crypto/sm4/build.info", "crypto/modes/build.info", "crypto/bn/build.info", "crypto/rsa/build.info", "crypto/dh/build.info", "crypto/dso/build.info", "crypto/buffer/build.info", "crypto/bio/build.info", "crypto/stack/build.info", "crypto/lhash/build.info", "crypto/rand/build.info", "crypto/err/build.info", "crypto/evp/build.info", "crypto/asn1/build.info", "crypto/pem/build.info", "crypto/x509/build.info", "crypto/x509v3/build.info", "crypto/conf/build.info", "crypto/txt_db/build.info", "crypto/pkcs7/build.info", "crypto/pkcs12/build.info", "crypto/ui/build.info", "crypto/async/build.info", "crypto/kdf/build.info", "crypto/store/build.info", "test/ossl_shim/build.info" ],
  build_type => "release",
  builddir => ".",
  cflags => [  ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)arm-none-linux-gnueabi-gcc",
  minor => "1.1",
  openssl_algorithm_defines => [ "OPENSSL_NO_BLAKE2", "OPENSSL_NO_CAMELLIA", "OPENSSL_NO_CAST", "OPENSSL_NO_CHACHA", "OPENSSL_NO_CMAC", "OPENSSL_NO_CMS", "OPENSSL_NO_COMP", "OPENSSL_NO_CT", "OPENSSL_NO_DSA", "OPENSSL_NO_EC", "OPENSSL_NO_IDEA", "OPENSSL_NO_MD2", "OPENSSL_NO_MDC2", "OPENSSL_NO_OCSP", "OPENSSL_NO_POLY1305", "OPENSSL_NO_RC2", "OPENSSL_NO_RC5", "OPENSSL_NO_RMD160", "OPENSSL_NO_SEED", "OPENSSL_NO_SM2", "OPENSSL_NO_SRP", "OPENSSL_NO_TS", "OPENSSL_NO_WHIRLPOOL" ],
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_ASAN", "OPENSSL_NO_ASM", "OPENSSL_NO_ASYNC", "OPENSSL_NO_CAPIENG", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_DGRAM", "OPENSSL_NO_DTLS", "OPENSSL_NO_DTLS1", "OPENSSL_NO_DTLS1_METHOD", "OPENSSL_NO_DTLS1_2", "OPENSSL_NO_DTLS1_2_METHOD", "OPENSSL_NO_EC2M", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_ECDH", "OPENSSL_NO_ECDSA", "OPENSSL_NO_EGD", "OPENSSL_NO_ENGINE", "OPENSSL_NO_ERR", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_GOST", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_HW", "OPENSSL_NO_HW_CHIL", "OPENSSL_NO_HW_PADLOCK", "OPENSSL_NO_MSAN", "OPENSSL_NO_MULTIBLOCK", "OPENSSL_NO_NEXTPROTONEG", "OPENSSL_NO_OCB", "OPENSSL_NO_POSIX_IO", "OPENSSL_NO_PSK", "OPENSSL_NO_RFC3779", "OPENSSL_NO_SCRYPT", "OPENSSL_NO_SCTP", "OPENSSL_NO_SRTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_TLS1_3", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UI_CONSOLE", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_STATIC_ENGINE" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "",
  options => "--prefix=/home/hyq/workspace/arm/openssl enable-shared enable-threads -DTEST_ENG_OPENSSL_NO_ALGORITHMS enable-weak-ssl-ciphers no-afalgeng no-asan no-asm no-async no-blake2 no-buildtest-c++ no-camellia no-capieng no-cast no-chacha no-cmac no-cms no-comp no-crypto-mdebug no-crypto-mdebug-backtrace no-ct no-devcryptoeng no-dgram no-dsa no-dtls no-dtls1 no-dtls1-method no-dtls1_2 no-dtls1_2-method no-ec no-ec2m no-ec_nistp_64_gcc_128 no-ecdh no-ecdsa no-egd no-engine no-err no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-gost no-heartbeats no-hw no-hw-chil no-hw-padlock no-idea no-md2 no-mdc2 no-msan no-multiblock no-nextprotoneg no-ocb no-ocsp no-poly1305 no-posix-io no-psk no-rc2 no-rc5 no-rfc3779 no-rmd160 no-scrypt no-sctp no-seed no-sm2 no-srp no-srtp no-sse2 no-ssl-trace no-ssl3 no-ssl3-method no-tls1_3 no-ts no-ubsan no-ui-console no-unit-test no-whirlpool no-zlib no-zlib-dynamic",
  perl_archname => "i686-linux-gnu-thread-multi-64int",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.18.2",
  perlargv => [ "--prefix=/home/hyq/workspace/arm/openssl", "linux-armv4", "CC=arm-none-linux-gnueabi-gcc", "LD=arm-none-linux-gnueabi-ld", "AR=arm-none-linux-gnueabi-ar", "shared", "threads", "no-asm", "no-egd", "no-zlib", "no-hw", "no-rc5", "no-md2", "no-mdc2", "no-rc2", "no-idea", "no-camellia", "no-ec", "no-ecdsa", "no-ecdh", "no-cast", "no-dsa", "no-ssl3", "no-seed", "no-cms", "no-capieng", "no-sse2", "no-comp", "no-rfc3779", "no-ct", "no-rmd160", "no-poly1305", "no-chacha", "no-psk", "no-srp", "no-dgram", "no-ui", "no-sctp", "no-dtls", "no-dtls1", "no-dtls1_2", "no-dtls1-method", "no-dtls1_2-method", "no-ssl-trace", "no-cmac", "no-afalgeng", "no-static-engine", "no-ec2m", "no-posix-io", "no-whirlpool", "no-blake2", "no-ts", "no-scrypt", "no-hw-chil", "no-hw-padlock", "no-gost", "no-nextprotoneg", "no-engine", "no-ocsp", "no-ocb", "no-multiblock", "no-async", "no-srtp", "no-err", "-DTEST_ENG_OPENSSL_NO_ALGORITHMS", "enable-weak-ssl-ciphers" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => undef,
  ...
  prefix => "/home/hyq/workspace/arm/openssl",
  processor => "",
  rc4_int => "unsigned char",
  sdirs => [ "objects", "md4", "md5", "sha", "hmac", "siphash", "sm3", "des", "aes", "rc4", "aria", "bf", "sm4", "modes", "bn", "rsa", "dh", "dso", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "ui", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
